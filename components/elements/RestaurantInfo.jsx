...
export default function RestaurantInfo() {
  return (
    ...
    <div className='flex flex-col  md:flex-row items-center md:items-start md:justify-center gap-spacing-10'>
        ...
        md:flex-row  bg-accent2-light gap-spacing-4'>
        ...
        <div className=' bg-accent-light md:max-w-[100%]'>
           <div className='block'>
dedeeeeeeeeeeeeeeeeeeeeeedfdfdfdfd
           </div>
        </div>
        </div>

  ...
  return (
    ...
    <div className='font-vrg '>
        <div className='flex mb-10  '>
            <div className='pl-spacing-1 min-w-[80px]'  >
            <Image
            ...
            <div className='flex mb-2 md:mb-2 lg:mb-6 sm:mb-7  items-center  justify-between w-[200px] sm:w-[180px] lg:w-[250px]'>
                <div className='flex '>
        ...
        <div>
             <h2 className='w-[67%] truncate text-scales-large font-vb'>آشپزخانه صنعتی امیران</h2>
         </div>
            </div>
        </div>

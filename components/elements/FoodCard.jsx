  ...
  return (
    ...
    <div className='font-vrg  md:w-[50%] border-l-borders-xs border-t-[.5px] border-b-[.5px] border-surface-dark'>
        ...
        <div className=' font-vrg flex justify-between py-spacing-2 px-spacing-2'>
          ...
          <div className='md:w-[100px] lg:w-[150px]'>
          <Image
        ...
        <div className='w-[100%] hover:bg-surface-main transition-colors flex items-center justify-between px-spacing-2 py-spacing-2 mb-spacing-2'>
           ...
           <div className='text-center ml-spacing-1 bg-surface-main w-[30%] p-[4px] rounded-full text-accent-main border-borders-xs border-inactive-light shadow-shadows-small hover:bg-accent-light hover:text-surface-main transition-colors'>
              <AddFoodBtn/>
           </div>
        </div>
      </Link>

...
// import Img  from "../../public/images/deflogo-1.jpg"


export default  function FoodCard({name,image=Img,price,rate,items, id , comment, desc}) {
    ...
    <div  className='font-vrg  md:w-[50%] border-l-borders-xs border-t-[.5px] border-b-[.5px] border-surface-dark'>
        ...
        <div className=' font-vrg flex justify-between py-spacing-1 px-spacing-1 lg:px-spacing-2'onClick={() =>detailpage({items})}>
          <div className='mt-spacing-1 text-right flex-1'>
            ...
            <p className='text-right text-scales-caption w-[90%] text-slate-500'>{desc}</p>
          </div>

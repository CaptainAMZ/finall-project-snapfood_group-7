...
export default function Orders({show}) {
   ...
   if (show) {
    ...
    <div className='bg-white w-full h-full' >
      <div className=' bg-white min-w-[21rem] w-21 absolute left-spacing-0  min-h-screen py-spacing-0 px-spacing-2 overflow-auto  shadow-shadows-modal animate-order max-h-90'>

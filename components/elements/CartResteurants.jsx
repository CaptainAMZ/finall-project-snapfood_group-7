          ...
          <div className=" w-full flex items-center justify-between flex-col h-[60%] mt-7 ">
            <div className=" w-full text-center mb-12 ">
              ...
              <div className="w-full  flex justify-center mb-2 ">
                <img src="/images/icons8-star-20.png" alt="star" className=" object-cover w-[13px] h-[13px] ml-1 " />
                <span className="text-xs ml-2 font-vb ">{item.star}</span>
                <span className="text-xs text-gray-400 font-vrg">({item.rate}امتیاز)</span>
              </div>
            ...
            <footer className="flex justify-center ">
              <div className="w-48 h-10 flex items-center justify-center rounded-[72px] shadow-shadows-medium">
                ...
                <p className="text-xs font-vb"> {item.delivery.price}<span className="mr-[2px]">تومان</span></p>
              </div>
            </footer>
          </div>
        </Link>

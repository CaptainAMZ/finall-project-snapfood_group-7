        ...
        <div>
          <div className='flex flex-row flex-nowrap justify-between items-center px-[12px] py-[14px] bg-surface-light border-[1px] border-carbon-alphaLight rounded-lg mb-spacing-1'>
            <div className='flex flex-row flex-nowrap justify-center items-center'>
              ...
              <p className='inline-block w-auto h-auto m-spacing-0 p-spacing-0 font-vrg text-scales-caption leading-lineHeight-caption text-carbon-main'>دریافت در سریع‌ترین زمان ممکن</p>
            </div>

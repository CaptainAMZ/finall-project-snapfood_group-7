...
export default function Category({type,img}) {
  return (
    ...
    <a className="bg-transparent">
      <div className="relative p-[0.1875rem] h-[5.9375rem] border border-solid border-white rounded-xl shadow-category cursor-pointer transition duration-200 flex bg-white ">
        <Image src={img} className="border border-solid border-white rounded-xl w-full min-h-full object-fill"/>
